    ...
    partial class BehaviorDb
    {
        private _ Abyss = () => Behav()
            .Init("Archdemon Malphas",
                new State(
                    new OnDeathBehavior(new DropPortalOnDeath("Abyss of Demons Portal", 50)),
                    new State("default",
                        new PlayerWithinTransition(15, "basic")
                        ),
                    new State("basic",
                        new Prioritize(
                            new Follow(0.1),
                ...
                new MostDamagers(1,
                    ...
                    new ItemLoot("Greater Potion of Vitality", 0.01)
                ),
                new MostDamagers(1,
                    new ItemLoot("Potion of Defense", 1.0),
                    new ItemLoot("Greater Potion of Defense", 0.01)
                ),
                new GoldLoot(15, 20),
                  new FameLoot(15, 20),
                new Threshold(0.5,
                    new ItemLoot("Demon Blade", 0.0005),
                    new ItemLoot("Blaze Sword", 0.0005),
                    new ItemLoot("Blaze Shield", 0.0005),
                    new ItemLoot("Blaze Armor", 0.0005),
                    new ItemLoot("Blaze Ring", 0.0005)
                )
            )
        .Init("Abyss Idol",
          new State(
           ...
           new Threshold(0.5,
                         ...
                         new ItemLoot("Sword of Illumination",0.03)           
                         )
          )
