    ...
    partial class BehaviorDb
    {
        private _ Avatar = () => Behav()
            .Init("shtrs Defense System",
                new State(
                    new DropPortalOnDeath("The Shatters", percent: 100, dropDelaySec: 0, XAdjustment: 0, YAdjustment: 2, PortalDespawnTimeSec: 500),
            ...
            .Init("shtrs Pillar 1",
                new State(
                    ...
                    new State("PROTECT",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        /* new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Shoot(20, count: 10, projectileIndex: 0, fixedAngle: 10, coolDownOffset: 1000),
                        new Shoot(20, count: 10, projectileIndex: 0, fixedAngle: 10 * 2, coolDownOffset: 4000),
                        new Shoot(20, count: 10, projectileIndex: 0, fixedAngle: 10, coolDownOffset: 7000),
                        new Shoot(20, count: 10, projectileIndex: 0, fixedAngle: 10 * 2, coolDownOffset: 10000),
                        new Shoot(20, count: 10, projectileIndex: 0, fixedAngle: 10, coolDownOffset: 13000),
                        new Shoot(20, count: 10, projectileIndex: 0, fixedAngle: 10 * 2, coolDownOffset: 16000),
                        new Shoot(20, count: 10, projectileIndex: 0, fixedAngle: 10, coolDownOffset: 19000),
                        new Shoot(20, count: 10, projectileIndex: 0, fixedAngle: 10 * 2, coolDownOffset: 22000),
                        new Shoot(20, count: 10, projectileIndex: 0, fixedAngle: 10, coolDownOffset: 25000),
