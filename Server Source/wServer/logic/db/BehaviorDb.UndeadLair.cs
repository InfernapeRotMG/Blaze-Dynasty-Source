    ...
    partial class BehaviorDb
    {
        private _ UndeadLair = () => Behav()
            .Init("Septavius the Ghost God",
                new State(
                   new DropPortalOnDeath("Undead Lair Portal", 50),
                    new State("Idle",
                ...
                new GoldLoot(5, 10),
                  new FameLoot(5, 10),
                new Threshold(0.5, /* Maximum 3 wis, minimum 0 wis */
                    new ItemLoot("Potion of Wisdom", 1),
                    new ItemLoot("Greater Potion of Wisdom",0.01)
                ),
                new Threshold(0.1,
                    new ItemLoot("Bow of the Morning Star", 0.001),
                    new ItemLoot("Doom Bow", 0.003),
                    new ItemLoot("Dragon Breath Sword", 0.0005),
                    new ItemLoot("Dragon Breath Helmet", 0.0005),
                    new ItemLoot("Dragon Breath Armor", 0.0005),
                    new ItemLoot("Dragon Breath Ring", 0.0005),
                ...
                new Threshold(0.1,
                    ...
                    new EggLoot(EggRarity.Rare, 0.001)
                )
            )
