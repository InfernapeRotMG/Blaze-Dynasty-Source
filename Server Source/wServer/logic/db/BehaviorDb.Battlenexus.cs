    ...
    partial class BehaviorDb
    {
        private _ BattlefortheNexus = () => Behav()
            .Init("Oryx the Mad God Deux",
                ...
                new Threshold(0.1,
                    new ItemLoot("Sunshine Shiv", 0.05),
                    new ItemLoot("Spicy Wand of Spice", 0.05),
                    new ItemLoot("Doctor Swordsworth", 0.05),
                    new ItemLoot("KoalaPOW", 0.05),
                    new ItemLoot("Robobow", 0.05    )
                )
              )
