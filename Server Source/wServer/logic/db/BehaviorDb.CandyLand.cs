...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        .Init("Candy Gnome",
            new State(
                new DropPortalOnDeath("Candyland Portal", percent: 100, PortalDespawnTimeSec: 120),
                new Prioritize(
                    new StayBack(1.0, 55),
                    new Wander(1.4)
                    )
            ...
            new Threshold(0.01,
                ...
                new ItemLoot("Candied Blade", 0.05),
        ...
        .Init("MegaRototo",
            new State(
                ...
                new Threshold(0.1,
                    ...
                    new ItemLoot("Fairy Plate", 0.0025),
                    new ItemLoot("Pixie-Enchanted Sword", 0.0025),
                    new ItemLoot("Seal of the Enchanted Forest", 0.0025),
                    new ItemLoot("Candy-Coated Armor", 0.01),
                    new ItemLoot("Ring of Pure Wishes", 0.0025),
