    ...
    partial class BehaviorDb
    {
        ...
        .Init("Sprite God",
                new State(
                    ...
                    new Spawn("Sprite Child", maxChildren: 10)
                    ),
                  new GoldLoot(1, 5),
                  new FameLoot(1, 5),
                new Threshold(0.18,
                    new ItemLoot("Potion of Dexterity", 0.75),
                    new EggLoot(EggRarity.Common, 0.1),
                    new EggLoot(EggRarity.Uncommon, 0.05)
                    )
            )
                ...
                new State(
                    ...
                    new Shoot(12, projectileIndex: 0, count: 5, shootAngle: 10, predictive: 1, coolDown: 1200),
                    new Shoot(10, projectileIndex: 1, predictive: 1, coolDown: 700)
                    ),
                  new GoldLoot(1, 15),
                  new FameLoot(1, 15),
                new Threshold(0.18,
            ...
            .Init("Medusa",
                ...
                new Threshold(0.18,
                    ...
                    new ItemLoot("Demon Blade", 0.00000001),
                    new EggLoot(EggRarity.Common, 0.1),
                    new EggLoot(EggRarity.Uncommon, 0.05)
                    )
            )
            ...
            .Init("Beholder",
                ...
                new Threshold(0.18,
                    new ItemLoot("Potion of Defense", 0.5),
                    new ItemLoot("Ancient Stone Sword", 0.0001),
                    new EggLoot(EggRarity.Common, 0.1),
                    new EggLoot(EggRarity.Uncommon, 0.05)
                    )
            )
            ...
            .Init("Ghost God",
                ...
                new Threshold(0.18,
                    ...
                    new ItemLoot("Doom Bow", 0.00000001),
                    new EggLoot(EggRarity.Common, 0.1),
                    new EggLoot(EggRarity.Uncommon, 0.05)
                    )
            )
