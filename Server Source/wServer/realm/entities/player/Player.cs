...
using wServer.realm.entities.player.quests;
...
namespace wServer.realm.entities.player
{
    ...
    public partial class Player : Character, IContainer, IPlayer
    {
        ...
        public QuestManager playerQuestManager { get; private set; }
        ...
        public void Death(string killer, ObjectDesc desc = null)
        {
            ...
            if (announce == true)
            {
                var saytext = $"{Name} Has Been Killed By {desc.ObjectId}, {Name} died at level: {Level},\n and was {maxed}/8 with {Fame} fame!";
        ...
        public override void Tick(RealmTime time)
        {
            ...
            */
            ...
            if (Owner is XPRoom && Level >= 20 && Client.Account.Rank != 16 || Owner is XPRoom && Level <= 0 && Client.Account.Rank != 16)
            {
                Client.Disconnect();
            }
