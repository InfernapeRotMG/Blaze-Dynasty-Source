                ...
                switch (eff.Effect)
                {
                    ...
                    case ActivateEffects.UnlockVault:
                        Manager.Database.DoActionAsync(db =>
                        {
                            ...
                            cmd.ExecuteNonQuery();
                            SendInfo("New vault chest unlocked successfully.");
                        });
                        break;


                    case ActivateEffects.UnlockSlot:
                        Manager.Database.DoActionAsync(db =>
                        {
                            MySqlCommand cmd = db.CreateQuery();
                            ...
                            cmd.Parameters.AddWithValue("@accId", Client.Account.AccountId);
                            cmd.ExecuteNonQuery();
                            SendInfo("New character slot unlocked successfully.");
                        });
                        break;
