...
namespace wServer.realm.worlds
{
    ...
    {
        public const string WINTER_RESOURCE = "wServer.realm.worlds.maps.nexus_summer.jm";
        public const string SUMMER_RESOURCE = "wServer.realm.worlds.maps.nexus_summer.jm";
        //public const string NEXUS_RESOURCE = "wServer.realm.worlds.maps.nexus2.jm";

        public Nexus()
        {
            Id = NEXUS_ID;
            Name = "Nexus";
            ClientWorldName = "Welcome to Blaze Dynasty";
            Background = 2;
            AllowTeleport = true;
            Difficulty = -1;
        }
