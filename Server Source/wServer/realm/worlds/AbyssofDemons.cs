...
//        {
//            LoadMap("wServer.realm.worlds.maps.AbyssNew.jm", MapType.Json);
//        }
...
namespace wServer.realm.worlds
{
    public class AbyssofDemons : World
    {
        ...
        protected override void Init()
        {
            LoadMap("wServer.realm.worlds.maps.WIP_ABYSS.jm", MapType.Json);
        }
        ...
        {
             "Imp of the Abyss", "Demon of the Abyss", "Demon Warrior of the Abyss", "Demon Mage of the Abyss", "Brute of the Abyss", "Brute Warrior of the Abyss"
        };
        ...
        {
            "Archdemon Malphas", "Red Demon"
        };
        private readonly string[] EndLoot =
        {
            "Wine Cellar Incantation", "Demon Blade", "Supply Crate Series #1", "Demon Essence"
        };
        private readonly string[] BasicLoot =
        {
            "Potion of Wisdom", "Potion of Defense"
        };
        ...
        private void SpawnLoot()
        {
            ...
            int chance = TimesCompleted >= 5 ? (5) : (TimesCompleted * 1);
            if (r.Next(100) < chance)
            {
                for (int i = 0; i < TimesCompleted; i++)
                {
                    items.Add(Manager.GameData.Items[Manager.GameData.IdToObjectType[BasicLoot[r.Next(0, BasicLoot.Length)]]]);
